      ...
      <v-flex>
        <v-container>
          <v-layout row wrap>
            ...
            <v-flex sm4 xs12>
              <span class="headline red--text">{{image.vixen}}</span><br />
              I Love: <span class="small blue--text">{{image.interests}}</span>
              <v-card-media
              :src="src"
              height="200px"
              class="mb-4"
          ...
          <v-date-picker v-if="!hours" color="green lighten-1" header-color="primary" v-model="date"></v-date-picker>
          <v-time-picker v-else v-model="time"></v-time-picker>
              ...
              <v-dialog v-model="dialog" persistent max-width="500px">
                ...
                <v-card>
                  ...
                  <v-card-text>
                    <v-container grid-list-md>
                      <v-layout wrap>
                        ...
                        <v-flex xs12 sm6 md6>
                          ...
                          required v-model="personal.lastname"
                          ></v-text-field>
                        </v-flex>
                        <v-flex xs12>
                    ...
                    <small>Note: We do not <strong>save your information</strong> on our databases. These are for contact and hook up only.</small>
                  </v-card-text>
                  <v-card-actions>
                    <v-spacer></v-spacer>
...
export default {
  ...
  watch: {
    date (value) {
      ...
      this.message = 'Gotcha lets hook up'
      this.snackbar = true
      this.alert = true
      this.color = 'success'
    }
