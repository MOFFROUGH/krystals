        ...
        <div v-show="consent">
          ...
          <v-container fluid v-bind="{ [`grid-list-${size}`]: true }">
            ...
            <v-card-actions>
              <v-layout row wrap>
                <v-flex sm12>
                  <v-btn block round large  color="red" dark :to="'/executive/'+image.id">Hook Up with Me</v-btn>
                </v-flex>
                <v-flex sm12>
                  <v-btn block round large  color="orange" dark :to="'/executive/party/'+image.id">Duo, Trio, Party</v-btn>
                </v-flex>
              </v-layout>
          </v-card-actions>
        </v-card>
